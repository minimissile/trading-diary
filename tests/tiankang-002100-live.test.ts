...
function mapFeeProfile(row: FeeProfileRow): FeeProfileRates {
  return {
    ...
    usCommissionPerShare:
      row.us_commission_per_share_micros === null ? null : row.us_commission_per_share_micros / 10_000,
...
describe('002100 live DB', () => {
  it.skipIf(!existsSync(DB_PATH))('deducts estimated sell fees from live ledger and quote', async () => {
